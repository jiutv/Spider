...
public class AppRJ extends Spider {
    ...
    public String homeContent(boolean filter) {
        ...
        classes.add(new Class("2", "内地"));
        classes.add(new Class("3", "电影"));
        classes.add(new Class("4", "动漫"));
        classes.add(new Class("5", "综艺"));
        classes.add(new Class("6", "韩剧"));
        classes.add(new Class("7", "泰剧"));
        classes.add(new Class("8", "港剧"));
        classes.add(new Class("9", "日剧"));
        classes.add(new Class("10", "美剧"));
        classes.add(new Class("11", "台剧"));
